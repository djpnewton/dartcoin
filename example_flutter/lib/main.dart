...
class BlockStorageDemoApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Block Storage Demo',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Colors.deepPurple),
        useMaterial3: true,
      ),
      home: const BlockStorageDemoPage(),
    );
  }
}
...
class _BlockStorageDemoPageState extends State<BlockStorageDemoPage> {
  ...
  Future<void> _runDemo() async {
    ...
    try {
      final loaded = await blockLoad(blockHash);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Block Storage Demo'),
      ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _DetailRow(label: 'Backend', value: storageBackendName()),
          ],
        ),
      ),
    );
