...
void main() {
  ...
  test('dartcoin reorg', () async {
    ...
    // invalidate the block 50 in the second process
    await proc2.rpc.invalidateBlock(hash50);
    // generate 100 blocks in the second process (reorg the first chain)
    ...
    await node.waitForBlockCount(149);
    ...
    expect(bestHashProc1, equals(hash149));
    expect(bestHashNode, equals(hash149));
